...
Register: [free tickets via EventBrite](https://www.eventbrite.co.uk/e/simulation-for-factorial-designs-with-faux-w-lisa-debruine-tickets-153666134545)

In this workshop I will introduce the {faux} R package for simulating factorial designs from existing data or data parameters. I will also cover adding continuous predictors to existing data and simulating multiple datasets for simulation studies.


#### Prep

* Install R packages from CRAN: `tidyverse`, `faux`, `afex`, `broom`
* Download files:  [faux-stub.Rmd](https://raw.githubusercontent.com/debruine/data-sim-workshops/master/inst/stubs/faux-stub.Rmd), [calories-stub.Rmd](https://raw.githubusercontent.com/debruine/data-sim-workshops/master/inst/stubs/calories-stub.Rmd)
