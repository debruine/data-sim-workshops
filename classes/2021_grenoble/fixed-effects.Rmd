...
rolls <- sample(0:1, 10000, replace = TRUE,
                prob = c(.4, .6))
...
```{r rbinom-bias}
# 20 individual coin flips of a biased (0.75) coin
rbinom(20, 1, 0.75)
```
...
ggplot() +
  geom_density(aes(x = dv), fill = fill_colour) +
  scale_x_continuous(
    limits = c(0,20), 
    breaks = seq(0,20)
  )
